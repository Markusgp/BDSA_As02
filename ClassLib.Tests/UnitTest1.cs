...
namespace ClassLib.Tests
{
    public class UnitTest1
    {
        ...
        public void ToString_OutPut_Student()
        {
            ...
            string expected = "ID:10, GivenName:navn, SurName:efternavn, StartDate:10/06/2017 00/00/00, EndDate:25/06/2020 00/00/00, GraduationDate:25/06/2020 00/00/00".Replace("/",".");
